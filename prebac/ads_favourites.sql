...
CREATE TABLE `favourites` (
  ...
  PRIMARY KEY (`id`),
  KEY `favourites_ad_id_foreign` (`ad_id`),
  KEY `favourites_user_id_foreign` (`user_id`),
  CONSTRAINT `favourites_ad_id_foreign` FOREIGN KEY (`ad_id`) REFERENCES `ads` (`id`) ON DELETE CASCADE,
...
INSERT INTO `favourites` VALUES (1,96,3);
